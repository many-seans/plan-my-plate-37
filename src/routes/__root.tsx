...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Prepbowl — Weekly Meal Prep, Made Easy" },
      { name: "twitter:title", content: "Prepbowl — Weekly Meal Prep, Made Easy" },
      { property: "og:description", content: "AI-powered weekly meal plans, shopping lists, and saved favourites. Built for busy weeknights." },
      { name: "twitter:description", content: "AI-powered weekly meal plans, shopping lists, and saved favourites. Built for busy weeknights." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/114a1f94-7f4e-41c1-928c-d8866a048a07" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/114a1f94-7f4e-41c1-928c-d8866a048a07" },
